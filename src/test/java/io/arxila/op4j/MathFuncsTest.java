...
import io.arxila.op4j.functions.FnDouble;
import io.arxila.op4j.functions.FnFloat;
import io.arxila.op4j.functions.FnInteger;
import io.arxila.op4j.functions.FnLong;
...
public class MathFuncsTest extends TestCase {
	...
	public void testDouble() {
		...
		Object aResult = io.arxila.op4j.test.auto.Test.testOnList(doubleList, testOperations);
		index = 0;
		...
		aResult = io.arxila.op4j.test.auto.Test.testOnArrayOf(Types.DOUBLE, doubleList.toArray(new Double[]{}), 
				testOperations);
		System.out.println("Result onArray: " + ArrayUtils.toString((Object[])aResult));
		aResult = io.arxila.op4j.test.auto.Test.testOnSet(new LinkedHashSet<Double>(doubleList), 
				testOperations);
	...
	public void testLong() {
		...
		testOperations.add(new TestOperation("endFor"));
		testOperations.add(new TestOperation("get"));
		Object aResult = io.arxila.op4j.test.auto.Test.testOnList(longList, testOperations);
		index = 0;
		...
		System.out.println("Result onList: " + aResult);
		aResult = io.arxila.op4j.test.auto.Test.testOnArrayOf(Types.LONG, longList.toArray(new Long[]{}), 
				testOperations);
		System.out.println("Result onArray: " + ArrayUtils.toString((Object[])aResult));
		aResult = io.arxila.op4j.test.auto.Test.testOnSet(new LinkedHashSet<Long>(longList), 
				testOperations);
		System.out.println("Result onSet: " + aResult);	
	...
	public void testInteger() {
		...
		testOperations.add(new TestOperation("endFor"));
		testOperations.add(new TestOperation("get"));
		Object aResult = io.arxila.op4j.test.auto.Test.testOnList(integerList, testOperations);
		index = 0;
		...
		System.out.println("Result onList: " + aResult);
		aResult = io.arxila.op4j.test.auto.Test.testOnArrayOf(Types.INTEGER, integerList.toArray(new Integer[]{}), 
				testOperations);
		System.out.println("Result onArray: " + ArrayUtils.toString((Object[])aResult));
		aResult = io.arxila.op4j.test.auto.Test.testOnSet(new LinkedHashSet<Integer>(integerList), 
				testOperations);
		System.out.println("Result onSet: " + aResult);	
...
//			}).get();
		...
		testOperations.add(new TestOperation("get"));
//		Map<String, List<Integer>> mapResult = (Map<String, List<Integer>>)io.arxila.op4j.test.auto.Test.testOnMapOfList(mapOfIntegerList, testOperations);
//		index = 0;
...
//		}
	...
	public void testBigDecimal() {
		...
		testOperations.add(new TestOperation("endFor"));
		testOperations.add(new TestOperation("get"));
		Object aResult = io.arxila.op4j.test.auto.Test.testOnList(bigDecimalList, testOperations);
		index = 0;
		...
		System.out.println("Result onList: " + aResult);
		aResult = io.arxila.op4j.test.auto.Test.testOnArrayOf(Types.BIG_DECIMAL, bigDecimalList.toArray(new BigDecimal[]{}), 
				testOperations);
		System.out.println("Result onArray: " + ArrayUtils.toString((Object[])aResult));
		aResult = io.arxila.op4j.test.auto.Test.testOnSet(new LinkedHashSet<BigDecimal>(bigDecimalList), 
				testOperations);
		System.out.println("Result onSet: " + aResult);			
	}
	...
	public void testBigInteger() {
		...
		testOperations.add(new TestOperation("endFor"));
		testOperations.add(new TestOperation("get"));
		Object aResult = io.arxila.op4j.test.auto.Test.testOnList(bigIntegerList, testOperations);
		index = 0;
		...
		System.out.println("Result onList: " + aResult);
		aResult = io.arxila.op4j.test.auto.Test.testOnArrayOf(Types.BIG_INTEGER, bigIntegerList.toArray(new BigInteger[]{}), 
				testOperations);
		System.out.println("Result onArray: " + ArrayUtils.toString((Object[])aResult));
		aResult = io.arxila.op4j.test.auto.Test.testOnSet(new LinkedHashSet<BigInteger>(bigIntegerList), 
				testOperations);
		System.out.println("Result onSet: " + aResult);		
	}
	...
	public void testFloat() {
		...
		testOperations.add(new TestOperation("endFor"));
		testOperations.add(new TestOperation("get"));
		Object aResult = io.arxila.op4j.test.auto.Test.testOnList(floatList, testOperations);
		index = 0;
		...
		System.out.println("Result onList: " + aResult);
		aResult = io.arxila.op4j.test.auto.Test.testOnArrayOf(Types.FLOAT, floatList.toArray(new Float[]{}), 
				testOperations);
		System.out.println("Result onArray: " + ArrayUtils.toString((Object[])aResult));
		aResult = io.arxila.op4j.test.auto.Test.testOnSet(new LinkedHashSet<Float>(floatList), 
				testOperations);
		System.out.println("Result onSet: " + aResult);
	}
	...
	public void testShort() {
		...
		testOperations.add(new TestOperation("endFor"));
		testOperations.add(new TestOperation("get"));
		Object aResult = io.arxila.op4j.test.auto.Test.testOnList(shortList, testOperations);
		index = 0;
		...
		System.out.println("Result onList: " + aResult);
		aResult = io.arxila.op4j.test.auto.Test.testOnArrayOf(Types.SHORT, shortList.toArray(new Short[]{}), 
				testOperations);
		System.out.println("Result onArray: " + ArrayUtils.toString((Object[])aResult));
		aResult = io.arxila.op4j.test.auto.Test.testOnSet(new LinkedHashSet<Short>(shortList), 
				testOperations);
		System.out.println("Result onSet: " + aResult);

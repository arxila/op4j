 ...
 *
 */
public interface ILevel2MapEntriesSelectedKeySelectedOperator<I,K,V>
    ...
    public ILevel2MapEntriesSelectedKeyOperator<I,K,V> endIf();

    public ILevel2MapEntriesSelectedKeySelectedOperator<I,K,V> replaceWith(final K replacement);

    public ILevel2MapEntriesSelectedKeySelectedOperator<I,K,V> exec(final IFunction<? super K,? extends K> function);

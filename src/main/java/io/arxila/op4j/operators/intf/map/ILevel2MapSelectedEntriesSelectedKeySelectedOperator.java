 ...
 *
 */
public interface ILevel2MapSelectedEntriesSelectedKeySelectedOperator<I,K,V>
        extends UniqOperator<Map<K,V>>,
                ExecutableSelectedOperator<K>,
                ReplaceableOperator<K>,
                SelectedMapEntryComponentOperator<K> {



    public ILevel2MapSelectedEntriesSelectedKeyOperator<I,K,V> endIf();

    public ILevel2MapSelectedEntriesSelectedKeySelectedOperator<I,K,V> replaceWith(final K replacement);

    public ILevel2MapSelectedEntriesSelectedKeySelectedOperator<I,K,V> exec(final IFunction<? super K,? extends K> function);

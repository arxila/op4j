 ...
 *
 */
public interface ILevel2MapEntriesKeySelectedOperator<I,K,V>
    ...
    public ILevel2MapEntriesKeyOperator<I,K,V> endIf();

    public ILevel2MapEntriesKeySelectedOperator<I,K,V> replaceWith(final K replacement);

 ...
 *
 */
public interface ILevel1ArrayElementsSelectedOperator<I,T>
    ...
    public ILevel1ArrayElementsOperator<I,T> endIf();


    public ILevel1ArrayElementsSelectedOperator<I,T> replaceWith(final T replacement);

    public ILevel1ArrayElementsSelectedOperator<I,T> exec(final IFunction<? super T,? extends T> function);

...
import io.arxila.op4j.operators.qualities.CastableToSetOperator;
import io.arxila.op4j.operators.qualities.ConvertibleToArrayOperator;
import io.arxila.op4j.operators.qualities.ConvertibleToListOperator;
import io.arxila.op4j.operators.qualities.ConvertibleToMapOfSetOperator;
import io.arxila.op4j.operators.qualities.ConvertibleToMapOperator;
import io.arxila.op4j.operators.qualities.ExecutableSetOperator;
import io.arxila.op4j.operators.qualities.GenerizableOperator;
import io.arxila.op4j.operators.qualities.ModifiableCollectionOperator;
import io.arxila.op4j.operators.qualities.NavigableCollectionOperator;
...
import io.arxila.op4j.operators.qualities.TotalizableOperator;
...
public interface ILevel0SetOperator<I,T>
    ...
    public <K,V> ILevel0MapOperator<I,K,Set<V>> toGroupMap(final IFunction<? super T,K> keyFunction, final IFunction<? super T,V> valueFunction);

 ...
 *
 */
public interface ILevel1ArraySelectedElementsSelectedOperator<I,T>
    ...
    public ILevel1ArraySelectedElementsOperator<I,T> endIf();


    public ILevel1ArraySelectedElementsSelectedOperator<I,T> replaceWith(final T replacement);

    public ILevel1ArraySelectedElementsSelectedOperator<I,T> exec(final IFunction<? super T,? extends T> function);

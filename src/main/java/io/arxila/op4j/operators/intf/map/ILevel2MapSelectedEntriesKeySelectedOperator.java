...
public interface ILevel2MapSelectedEntriesKeySelectedOperator<I,K,V>
    ...
    public ILevel2MapSelectedEntriesKeyOperator<I,K,V> endIf();

    public ILevel2MapSelectedEntriesKeySelectedOperator<I,K,V> replaceWith(final K replacement);

    public ILevel2MapSelectedEntriesKeySelectedOperator<I,K,V> exec(final IFunction<? super K,? extends K> function);

...
import io.arxila.op4j.operators.qualities.SelectedMapEntryOperator;
 ...
 *
 */
public interface ILevel1MapSelectedEntriesSelectedOperator<I,K,V>
    ...
    public ILevel1MapSelectedEntriesOperator<I,K,V> endIf();
    

    public ILevel2MapSelectedEntriesSelectedKeyOperator<I,K,V> onKey();
    public ILevel2MapSelectedEntriesSelectedValueOperator<I,K,V> onValue();
    
    public ILevel1MapSelectedEntriesSelectedOperator<I,K,V> replaceWith(final Map.Entry<K,V> replacement);

...
import io.arxila.op4j.operators.intf.map.ILevel2MapSelectedEntriesSelectedValueOperator;
...
public final class Level2MapSelectedEntriesSelectedValueOperator<I,K,V> extends AbstractOperator implements UniqOpOperator<I,Map<K,V>>, ILevel2MapSelectedEntriesSelectedValueOperator<I,K,V> {


    public Level2MapSelectedEntriesSelectedValueOperator(final Target target) {
        super(target);
    }


    public Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V> ifTrue(final IFunction<? super V,Boolean> eval) {
        return new Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V>(getTarget().selectMatching(eval));
    }


    public Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V> ifFalse(final IFunction<? super V,Boolean> eval) {
        return new Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V>(getTarget().selectNotMatching(eval));
    }
    ...
    public Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V> ifNotNullAndFalse(final IFunction<? super V,Boolean> eval) {
        return new Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V>(getTarget().selectNotNullAndNotMatching(eval));
    }
    ...
    public Level2MapSelectedEntriesSelectedValueOperator<I,K,V> exec(final IFunction<? super V,? extends V> function) {
        return new Level2MapSelectedEntriesSelectedValueOperator<I,K,V>(getTarget().execute(function, Normalisation.NONE));
    }


    public Level2MapSelectedEntriesSelectedValueOperator<I,K,V> replaceWith(final V replacement) {
        return new Level2MapSelectedEntriesSelectedValueOperator<I,K,V>(getTarget().replaceWith(replacement, Normalisation.NONE));
    }

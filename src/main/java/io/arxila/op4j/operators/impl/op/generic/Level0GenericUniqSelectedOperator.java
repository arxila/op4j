...
import io.arxila.op4j.operators.intf.generic.ILevel0GenericUniqSelectedOperator;
...
public final class Level0GenericUniqSelectedOperator<I,T> extends AbstractOperator implements UniqOpOperator<I,T>, ILevel0GenericUniqSelectedOperator<I,T> {

...
import io.arxila.op4j.operators.intf.map.ILevel2MapEntriesSelectedKeySelectedOperator;
...
public final class Level2MapEntriesSelectedKeySelectedOperator<I,K,V> extends AbstractOperator implements UniqFnOperator<I,Map<K,V>>, ILevel2MapEntriesSelectedKeySelectedOperator<I,K,V> {

...
import io.arxila.op4j.operators.intf.map.ILevel2MapEntriesKeySelectedOperator;
...
public final class Level2MapEntriesKeySelectedOperator<I,K,V> extends AbstractOperator implements UniqFnOperator<I,Map<K,V>>, ILevel2MapEntriesKeySelectedOperator<I,K,V> {


    public Level2MapEntriesKeySelectedOperator(final Target target) {
        super(target);
    }


    public Level2MapEntriesKeyOperator<I,K,V> endIf() {
        return new Level2MapEntriesKeyOperator<I,K,V>(getTarget().endSelect());
    }
    ...
    public Level2MapEntriesKeySelectedOperator<I,K,V> replaceWith(final K replacement) {
        return new Level2MapEntriesKeySelectedOperator<I,K,V>(getTarget().replaceWith(replacement, Normalisation.NONE));
    }

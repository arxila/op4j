...
public final class Level2MapSelectedEntriesSelectedValueOperator<I,K,V> extends AbstractOperator implements UniqFnOperator<I,Map<K,V>>, ILevel2MapSelectedEntriesSelectedValueOperator<I,K,V> {

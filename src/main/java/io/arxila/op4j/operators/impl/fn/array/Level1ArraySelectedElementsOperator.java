...
import io.arxila.op4j.operators.intf.array.ILevel1ArraySelectedElementsOperator;
...
public final class Level1ArraySelectedElementsOperator<I,T> extends AbstractOperator implements UniqFnOperator<I,T[]>, ILevel1ArraySelectedElementsOperator<I,T> {

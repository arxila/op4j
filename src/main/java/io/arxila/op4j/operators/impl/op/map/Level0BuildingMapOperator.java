...
import io.arxila.op4j.functions.FnMap;
import io.arxila.op4j.functions.IFunction;
import io.arxila.op4j.operators.impl.AbstractOperator;
import io.arxila.op4j.operators.impl.op.generic.Level0GenericUniqOperator;
 ...
 *
 */
public final class Level0BuildingMapOperator<I,K,V> extends AbstractOperator
        implements UniqOpOperator<I,Map<K,V>>, ILevel0BuildingMapOperator<I,K,V> {

    
    public Level0BuildingMapOperator(final Target target) {
        super(target);
    }
    ...
    public Level0BuildingMapOperator<I, K, V> and(K key, V value) {
        return new Level0BuildingMapOperator<I,K,V>(getTarget().execute(FnMap.ofObjectObject().put(key, value)));
    }

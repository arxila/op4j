...
import io.arxila.op4j.operators.intf.map.ILevel2MapEntriesSelectedKeyOperator;
...
public final class Level2MapEntriesSelectedKeyOperator<I,K,V> extends AbstractOperator implements UniqOpOperator<I,Map<K,V>>, ILevel2MapEntriesSelectedKeyOperator<I,K,V> {

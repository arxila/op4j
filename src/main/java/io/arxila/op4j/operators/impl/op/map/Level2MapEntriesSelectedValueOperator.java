...
import io.arxila.op4j.operators.intf.map.ILevel2MapEntriesSelectedValueOperator;
...
public final class Level2MapEntriesSelectedValueOperator<I,K,V> extends AbstractOperator implements UniqOpOperator<I,Map<K,V>>, ILevel2MapEntriesSelectedValueOperator<I,K,V> {

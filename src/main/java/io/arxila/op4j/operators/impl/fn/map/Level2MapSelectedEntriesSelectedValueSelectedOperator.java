...
import io.arxila.op4j.operators.intf.map.ILevel2MapSelectedEntriesSelectedValueSelectedOperator;
...
public final class Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V> extends AbstractOperator implements UniqFnOperator<I,Map<K,V>>, ILevel2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V> {

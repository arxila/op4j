...
import io.arxila.op4j.operators.intf.map.ILevel2MapSelectedEntriesKeyOperator;
...
public final class Level2MapSelectedEntriesKeyOperator<I,K,V> extends AbstractOperator implements UniqFnOperator<I,Map<K,V>>, ILevel2MapSelectedEntriesKeyOperator<I,K,V> {

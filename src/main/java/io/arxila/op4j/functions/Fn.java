...
import io.arxila.op4j.operators.impl.fn.array.Level0ArrayOperator;
import io.arxila.op4j.operators.impl.fn.generic.Level0GenericUniqOperator;
import io.arxila.op4j.operators.impl.fn.list.Level0ListOperator;
import io.arxila.op4j.operators.impl.fn.map.Level0MapOperator;
import io.arxila.op4j.operators.impl.fn.set.Level0SetOperator;
import io.arxila.op4j.target.ExecutionTarget;
 ...
 * as {@link io.arxila.op4j.Op}, but the results of expressions starting with <tt>Fn</tt>

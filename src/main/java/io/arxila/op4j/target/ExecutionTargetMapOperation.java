 ...
 *
 */
final class ExecutionTargetMapOperation implements ExecutionTargetOperation {
    ...
    public ExecutionTargetMapOperation(final Structure structure, final IFunction<?,?> executable, final Class<?> arrayComponentClass) {
        super();
